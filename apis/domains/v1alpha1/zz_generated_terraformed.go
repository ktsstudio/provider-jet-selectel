...
func (mg *DomainV1) GetTerraformResourceType() string {
	return "selectel_domains_domain_v1"
}
...
// LateInitialize this DomainV1 using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *DomainV1) LateInitialize(attrs []byte) (bool, error) {
	params := &DomainV1Parameters{}
...
func (mg *RecordV1) GetTerraformResourceType() string {
	return "selectel_domains_record_v1"
}
...
// LateInitialize this RecordV1 using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *RecordV1) LateInitialize(attrs []byte) (bool, error) {
	params := &RecordV1Parameters{}
	if err := json.TFParser.Unmarshal(attrs, params); err != nil {
		return false, errors.Wrap(err, "failed to unmarshal Terraform state parameters for late-initialization")
	}
	opts := []resource.GenericLateInitializerOption{resource.WithZeroValueJSONOmitEmptyFilter(resource.CNameWildcard)}
